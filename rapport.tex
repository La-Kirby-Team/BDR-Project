...
L'application permet de gérer et de voir le contenu des stocks d'un magasin (pour l'instant).
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \hspace{0.2\textwidth} % Espacement horizontal entre les images (5% de la largeur totale)
            % --- Deuxième image, placée à droite ---
            \node[anchor=south west] (img2) at (6,0) {\includegraphics[width=0.5\textwidth]{images/index1}};
            % Annotation sur la deuxième image
            \draw[blue, thick] (7, 1) ellipse (0.5cm and 0.25cm);
        \end{tikzpicture}
