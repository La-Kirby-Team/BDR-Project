...
L'application permet de gérer et de voir le contenu des stocks d'un magasin (pour l'instant).
    ...
    \begin{enumerate}
        ...
        \newline Une fois le répertoire cloné en local, il suffit de suivre les instructions contenues dans le fichier \href{https://github.com/La-Kirby-Team/BDR-Project/blob/main/README.md}{README.md}
